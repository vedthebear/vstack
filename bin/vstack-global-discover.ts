#!/usr/bin/env bun
/**
 * vstack-global-discover — Discover AI coding sessions across Claude Code, Codex CLI, and Gemini CLI.
 ...
 *
 * Usage:
 *   vstack-global-discover --since 7d [--format json|summary]
 *   vstack-global-discover --help
 */
...
function printUsage(): void {
  console.error(`Usage: vstack-global-discover --since <window> [--format json|summary]
...
Examples:
  vstack-global-discover --since 7d
  vstack-global-discover --since 14d --format summary`);
}
