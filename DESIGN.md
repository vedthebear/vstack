# Design System — vstack

## Product Context
- **What this is:** Community website for vstack — a CLI tool that turns Claude Code into a virtual engineering team
- **Who it's for:** Developers discovering vstack, existing community members
